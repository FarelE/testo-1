...
case 'laporan': 
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
              ...
              ronove.sendMessage(owner,`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
...
break;
  ...
  if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
            if (args.length == 0) return balas(`contoh: ${prefix + command} Vall`)
            sticWait(from)
            teks = args.join(" ")
...
case 'milf':  
            ...
            ronove.sendFileFromUrl(from, milfKey.image, 'milf.jpg', milfKey.teks)
            break
case 'yaoi':
            ...
            ronove.sendFileFromUrl(from, yaoiKey.image, 'yaoi.jpg', yaoiKey.teks)
            break
case 'waifu':
          case 'loli':
          case 'husbu':
