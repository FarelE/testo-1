...
cmhit.push(command)
  ...
  const reply = (teks) => {
    ...
    const balas = (teks) => {
      ronove.sendMessage(from, teks, text, { quoted: ftokoo });
    };
...
const katalog = (teks) => {
             res = ronove.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": `*${namaowner}*`, "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftokoo})
...
"externalAdReply": {
                ...
                "thumbnail": fake,
                "sourceUrl": ``
},mentionedJid:[sender]}, quoted :ftokoo})
};
const replywa = (teks) => {
ronove.sendMessage(from, teks, text,{contextInfo :{text: 'hi',
"forwardingScore": 1000000000,
...
NOTE : untuk mendapatkan limit. bisa lewat ${prefix}adventure atau buylimit`
      ...
      const point = Math.floor(Math.random() * 1) + 0
            ...
            //function check heal
             ...
             if (healCounts <= 0) return sendButMessage (from, heal1, heal2, heal3, { quoted: ftokoo})
		 ...
		 //funtion potion
          ...
          return true
           ...
           return false
            ...
            if (potionCounts <= 0) return sendButMessage (from, poti1, poti2, poti3, { quoted: ftokoo})
...
if(menuslow == false){
	if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: ftokoo})
	thu = await ronove.getStatus(`${sender.split('@')[0]}@s.whatsapp.net`, MessageType.text)
...
await ronove.sendMessage(from, skuygelud, MessageType.buttonsMessage, {quoted: ftokoo})
}
await limitAdd(sender)
break
case 'allmenu': 
                    ...
                    await ffmpeg(`${media}`)
							...
							.on('end', function () {
								...
								exec(`webpmux -set exif ./sticker/data.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
									...
									ronove.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), sticker, {quoted: ftokoo})
                                    fs.unlinkSync(media)	
...
case 'bokep': case 'bkp': case 'randombokep':{
             if (!isPremium && !isOwner) return sendButMessage (from, prem1, prem2, prem3, { quoted: ftokoo})
   if (isGroup && !isNsfw) return reply(`sange? aktifin fitur nsfw dulu dengan cara ${prefix}nsfw 1`)
                fetchJson(`https://pastebin.com/raw/k82VJzeP`).then((data) => {
                  ...
                  ronove.sendMessage(from, bokep2.teks, text, {quoted: ftokoo, thumbnail: iye})
                })
                }
                await limitAdd(sender)
break
...
case 'citacita':       
                     ...
                     ronove.sendMessage(from, cita2, MessageType.audio, {quoted: ftokoo, mimetype: 'audio/mp4', ptt:true, duration: -838719282910})
                     await limitAdd(sender)
break
       case 'kapankah':
       case 'kapan':
...
break
		       case 'limit':
                                if (!isLimit) return sendButMessage (from, limit1, limit2, limit3, { quoted:ftokoo})                
				    checkLimit(sender)
				    await limitAdd(sender)
break
        case 'shareloc':
...
break
			...
			ronove.sendMessage(from, glass, image, {quoted:ftokoo, caption: 'INI'})
			await limitAdd(sender)
break
    case 'tinyurl':
           if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
...
break 
                    ...
                    ronove.sendMessage(from, repur, image, { quoted:ftokoo})
                    await limitAdd(sender)
break
        					case 'pornhub':
               if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
        sticWait(from)
					...
					ronove.sendMessage(from, porn, image, {caption: 'PORNHUB', quoted:ftokoo})
					await limitAdd(sender)
break 
        case 'joox':
               if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
...
case 'buglink':
               ...
               ronove.sendMessage(from, virtex3(prefix), text, { quoted:ftokoo, contextInfo :{text: '🔥',
            "forwardingScore": 1000000000,
            isForwarded: false,
            sendEphemeral: false,
            "externalAdReply": {
...
ronove.sendMessage(from, listMsg, MessageType.listMessage, {quoted:ftokoo})
ronove.toggleDisappearingMessages(from, 0)
await limitAdd(sender)
break
case 'vietnam':
...
sticWait(from)
     ...
     ronove.sendMessage(from, ini_img, image, {quoted:ftokoo})
...
ronove.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [sender]},quoted:ftokoo})
await limitAdd(sender)
break
case 'downloadmenu':
...
const fakegrup = (teks) => {        
ronove.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted:ftokoo, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${namabot} GROUP`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`${setting.linkgcbot}`}}})
		}
menu = `ッ『 Gc Bot 』ッ
...
case 'ftoko':
ken = `tes`
ronove.sendMessage(from, ken, text, {quoted:ftokoo})
break
    case 'kurumi':
    case 'deku':
    case 'sao':
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
                     ...
                     ronove.sendMessage(from, atetepe, sticker, {quoted:ftokoo})
                     await limitAdd(sender)
break
// Encrypt Fiture
				case 'base64enc': 
...
break
				...
				encbinary = `${body.slice(11)}`
					...
					ronove.sendMessage(from, `${anu.result}`, text, {quoted: ftokoo})
					await limitAdd(sender)
break  
				case 'decbinary':
...
\`\`\`🐥 Link : ${get_data[i].url}\`\`\``
              ...
              ronove.sendMessage(from, ini_buffer, image, { quoted: ftokoo, caption: teks })
              } catch {
...
case 'asahotak':
					...
					ronove.sendMessage(from, 'Jawaban: '
                                          +anu.result.jawaban, text, {quoted:ftokoo}) // ur cods
					}, 60000) // 1000 = 1s,
                                        setTimeout( () => {
					...
					setTimeout( () => {
					ronove.sendMessage(from, asahh, text, {quoted:ftokoo}) // ur cods
					}, 0) // 1000 = 1s,
					await limitAdd(sender)
break
await limitAdd(sender)
...
break
		...
		if (!isRegistered) return reply(ind.noregis())
                    ...
                    ronove.sendMessage(from, ini_buffer, image, { quoted: ftokoo, caption: ini_txt })
                    break
                case 'nekopoisearch':
...
break
		...
		ronove.sendMessage(from, teff, image, { quoted:ftokoo, caption: '*DARE*\n\n'+ der })
		await limitAdd(sender)
break
        case 'caklontong':
              if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
					...
					setTimeout( () => {
					ronove.sendMessage(from, get, text, {quoted:ftokoo}) // ur cods
					}, 0) // 1000 = 1s,
					await limitAdd(sender)
break
case 'tebakkalimat':
...
case 'tebaklirik':
					...
					setTimeout( () => {
					ronove.sendMessage(from, 'Jawaban: '
                                          +anu.result.answer, text, {quoted:ftokoo}) // ur cods
					}, 60000) // 1000 = 1s,
                                        setTimeout( () => {
					ronove.sendMessage(from, '_10 Detik lagi..._', text) // ur cods
					}, 50000) // 1000 = 1s,
...
case 'tebakkimia':
					...
					setTimeout( () => {
					ronove.sendMessage(from, 'Jawaban: '
                                          +anu.result.lambang, text, {quoted:ftokoo}) // ur cods
					}, 60000) // 1000 = 1s,
                                        setTimeout( () => {
					ronove.sendMessage(from, '_10 Detik lagi..._', text) // ur cods
					}, 50000) // 1000 = 1s,
...
case 'tebakjenaka':
					...
					setTimeout( () => {
					ronove.sendMessage(from, tebakjenaka, text, {quoted:ftokoo}) // ur cods
					}, 0) // 1000 = 1s,
					await limitAdd(sender)
break
				case 'family100':
					...
					setTimeout( () => {
					ronove.sendMessage(from, family, text, {quoted:ftokoo}) // ur cods
					}, 0) // 1000 = 1s,
					await limitAdd(sender)
break
        				    case 'tebakgambar':
...
sendButLocation(from, `${lepel}`, `naikin xp dgn chat sebanyak² nya`, {jpegThumbnail:lepell}, [{buttonId:`leaderboard`,buttonText:{displayText:'Leaderboard📋'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}}, { quoted :ftokoo })
await limitAdd(sender)
break
case 'mining':
...
case 'chiisaihentai':
              ...
              prep = await ronove.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftokoo})
              ronove.relayWAMessage(prep)
...
break;
    case 'nhentaipdf':
    case 'nhentai':
             if (!isPremium) return sendButMessage (from, prem1, prem2, prem3, { quoted: ftokoo})
...
📃 Title Native : ${get_result.title_native}\n`
             ...
             ronove.sendMessage(from, ini_image, image, { caption: teks, quoted: ftokoo, thumbnail: Buffer.alloc(0) })
             sticWait(from)
             anu = await fetchJson(`https://api.lolhuman.xyz/api/nhentaipdf/${henid}?apikey=${lolkey}`)
             pdf = await getBuffer(anu.result)
             ronove.sendMessage(from, pdf, document, { quoted: ftokoo, mimetype: Mimetype.pdf, filename: `${args[0]}.pdf`, thumbnail: ini_image })
             } catch (e) {
             console.log(e)
             reply(String(e))
}
...
case 'bokep1':				 
				...
				qute = fs.readFileSync('./ronove.jpg') 
				   ...
				   ronove.sendMessage(from, qute, image, { quoted:ftokoo, caption: '*SEMOGA DI BERI HIDAYAH*\nLink Download \n\nhttps://www.mediafire.com/file/h2nygxbyb6n9cyo/VID-20210107-WA1468.mp4/file' })
				   await limitAdd(sender)
break
				   case 'bokep2':
...
break
     case 'ytlagu': 
      sticWait(from) 
                    ...
                    ronove.sendMessage(from, get_audio, audio, { mimetype: 'audio/mp4', quoted: ftokoo, ptt: true })
      await limitAdd(sender)
break
      case "emoji":
      case "semoji":
