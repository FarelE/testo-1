...
const rantai = fs.readFileSync('./stik/rantai.jpeg')
const asw1 = 'https://f.top4top.io/p_2073p4mwa0.jpg'
const sip = fs.readFileSync('./ronove.jpg')
const bgg = fs.readFileSync('./ronove.jpg')
//// Image ////
...
const checkRegisteredUser = (sender) => {
    ...
    const groupMetadata = isGroup ? await ronove.groupMetadata(from) : 'query'.toString;
...
if (budy.toLowerCase() === `8473`){
		if (isRegister) return 
		    ...
		    ronove.sendMessage(from, teks, text, {quoted: fexec })
...
const katalog = (teks) => {
             res = ronove.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": `*${namaowner}*`, "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:fexec})
...
"externalAdReply": {
                ...
                "thumbnail": fake,
                "sourceUrl": ``
},mentionedJid:[sender]}, quoted :fexec})
};
const replywa = (teks) => {
ronove.sendMessage(from, teks, text,{contextInfo :{text: 'hi',
"forwardingScore": 1000000000,
...
NOTE : untuk mendapatkan limit. bisa lewat ${prefix}adventure atau buylimit`
      ...
      const point = Math.floor(Math.random() * 1) + 0
            ...
            //function check heal
             ...
             if (healCounts <= 0) return sendButMessage (from, heal1, heal2, heal3, { quoted: fexec})
		 ...
		 //funtion potion
          ...
          return true
           ...
           return false
            ...
            if (potionCounts <= 0) return sendButMessage (from, poti1, poti2, poti3, { quoted: fexec})
...
if (!m.isBaileys && isGroup && isBadword && !isOwner && !isGroupAdmins && !mek.key.fromMe){
						for (let kasar of badword){
							if (budy.toLowerCase().includes(kasar)){
								if (isCountKasar(sender, senbadword)){
									if (!isBotGroupAdmins) return balas(`Kamu beruntung karena bot bukan admin`)
									...
									delCountKasar(sender, senbadword)
										...
										balas(`Kamu terdeteksi berkata kasar\nJangan ulangi lagi atau kamu akan dikick`)
									}
								}
							}
						}
    ...
    if (isGroup && isAntilink && !mek.key.fromMe) {
      if (budy.includes("chat.whatsapp.com")) {
        if (isGroupAdmins) return balas("admin bebas");
        balas("ANTILINK DETECTED!! MAAF ANDA AKAN DIKICK ;V");
        ronove.groupRemove(from, [sender]);
      }
    }
    ...
    if (
      ...
      balas(`@${sender.split("@")[0]} Terdeteksi mengirim pesan hidetag!!`);
      kick(from, sender);
    }
    ...
    if (isGroup && isAntivirtex && !mek.key.fromMe) {
      if (budy.length > 7000) {
        if (isGroupAdmins) return balas("admin bebas");
        balas("ANTIVIRTEX DETECTED!! MAAF ANDA AKAN DIKICK ;V");
        ronove.groupRemove(from, sender);
      }
    }
      ...
      if (sender.includes("62")) {
        ...
        const sendmenu = (teks) => {
        	...
        	//by ronove
                    ...
                    const sendbutrt = (teks) => {
        	//by ronove
                    ronove.sendMessage(from, { contentText: teks, footerText: ` `, buttons: [{ buttonId: `menu`, buttonText: { displayText: 'Menu⚡' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: rantai, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
                    }
...
break;
    ...
    'productMessage': {
        'product': {
            'productImage': {
                'url': 'https://mmg.whatsapp.net/d/f/ApwXoLeqWzecpGL__nyuREt45Ddj8CFlcZiCC3FSaajh.enc',
                'mimetype': 'image/jpeg',
                'fileSha256': 'vdUMo5lRSIEKQZdewGKLVYLZkV1CfdbOAT4KaMKYdZI=',
                'fileLength': 66676,
                'height': 816,
                'width': 816,
                'mediaKey': 'dLISECaxBaQVb2TGNtcvEZb+Z0d6Dkkv2jU4xe5jzhI=',
                'fileEncSha256': 'KS/KFgFpjL4IL8Hg/zchJrEHbyNkhrasFBC2yT3o0WU=',
                'jpegThumbnail': iye
            },
...
case 'menu':
if(menubiasa == true){
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fexec})
...
var titel = `RO-BOT`;
                                                           ...
                                                           ronove.sendMessage(m.chat, { contentText: ` `, footerText: menu, buttons: [{ buttonId: `rules`, buttonText: { displayText: 'RULES📃' }, type: 1 },{ buttonId: `command`, buttonText: { displayText: 'MENU📒' }, type: 1 } ], "headerType": "DOCUMENT", "documentMessage": { "url": "https://mmg.whatsapp.net/d/f/Ano5cGYOFQnC51uJaqGBWiCrSJH1aDCi8-YPQMMb1N1y.enc", "mimetype": "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "title": titel, "fileSha256": "8Xfe3NQDhjwVjR54tkkShLDGrIFKR9QT5EsthPyxDCI=", "fileLength": 999999999999, "pageCount": 999, "mediaKey": "XWv4hcnpGY51qEVSO9+e+q6LYqPR3DbtT4iqS9yKhkI=", "fileName": fake, "fileEncSha256": "NI9ykWUcXKquea4BmH7GgzhMb3pAeqqwE+MTFbH/Wk8=", "directPath": "/v/t62.7119-24/35160407_568282564396101_3119299043264875885_n.enc?ccb=11-4&oh=d43befa9a76b69d757877c3d430a0752&oe=61915CEC", "mediaKeyTimestamp": "1634472176", "jpegThumbnail": iye}}, MessageType.buttonsMessage, { quoted: floc, thumbnail: iye, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply: { title: ` `, thumbnail: iye, mediaType:"2", previewType: "VIDEO", mediaUrl: "https://youtu.be/JcCPeJTMuO4"}}})
                                                                                                            } catch (e) {                                             balas(`${e}`)
                                                       }
                                                       }
break
...
anu =`Silahkan pilih salah satu di bawah`
 buttons = [{buttonId: 'setmenu biasa', buttonText: {displayText: 'Location'}, type: 1},{buttonId: 'setmenu docx', buttonText: {displayText: 'Docx'}, type: 1}]
const skuygelud = {
    contentText: `${anu}`,
...
await ronove.sendMessage(from, skuygelud, MessageType.buttonsMessage, {quoted: fexec})
}
await limitAdd(sender)
break
case 'allmenu': 
...
//setpp by denz
        case 'getpp':
               ...
               linkpp = await ronove.getProfilePicture(from) || "https://telegra.ph/file/40151a65238ba2643152d.jpg"
               buffer = await getBuffer(linkpp)
               ronove.sendMessage(from, buffer, image, {caption: "Nih", quoted: freply })
               } else if (mek.message.extendedTextMessage.contextInfo.mentionedJid === null || mek.message.extendedTextMessage.contextInfo.mentionedJid === undefined) {
               mberr = mek.message.extendedTextMessage.contextInfo.participant
               linkpp = await ronove.getProfilePicture(mberr) || "https://telegra.ph/file/40151a65238ba2643152d.jpg"
               buffer = await getBuffer(linkpp)
               ronove.sendMessage(from, buffer, image, { quoted: freply, caption: `Profile Picture of @${mberr.split("@")[0]}`, contextInfo: { "mentionedJid": [mberr] }})
               } else if (mek.message.extendedTextMessage.contextInfo.mentionedJid.length > 0) {
               mberr = mek.message.extendedTextMessage.contextInfo.mentionedJid[0]
               linkpp = await ronove.getProfilePicture(mberr) || "https://telegra.ph/file/40151a65238ba2643152d.jpg"
               buffer = await getBuffer(linkpp)
               ronove.sendMessage(from, buffer, image, { quoted: fexec, caption: `Profile Picture of @${mberr.split("@")[0]}`, contextInfo: { "mentionedJid": [mberr] }})
}
               break
case 'setprofile':
				case 'setpp':
				ronove.updatePresence(from, Presence.composing)
				if (!isQuotedImage) return balas('Reply imagenya!')
					if (!isOwner && !mek.key.fromMe) return sticOwner(from)
...
break
case 'cekmati':
              if (!q) return balas('namanya sapa?')
              predea = await axios.get(`https://api.agify.io/?name=${q}`)
              balas(`Nama : ${predea.data.name}\n*Mati Pada Umur :* ${predea.data.age} Tahun.\n\n_Cepet Cepet Tobat Bro Soalnya Mati ga ada yang tau_`)
              await limitAdd(sender)
break
case 'apakah':
              apakah = body.slice(1)
                ...
                case 'bucinsticker':{
                    ...
                    await ffmpeg(`${media}`)
							...
							.on('error', function (err) {
								...
								fs.unlinkSync(media)
								balas(mess.error.api)
							})
							.on('end', function () {
								console.log('Finish')
								exec(`webpmux -set exif ./sticker/data.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
                                    if (error) return balas(mess.error.api)
									ronove.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), sticker, {quoted: fexec})
                                    fs.unlinkSync(media)	
...
case 'bokep': case 'bkp': case 'randombokep':{
             if (!isPremium && !isOwner) return sendButMessage (from, prem1, prem2, prem3, { quoted: fexec})
   if (isGroup && !isNsfw) return balas(`sange? aktifin fitur nsfw dulu dengan cara ${prefix}nsfw 1`)
                fetchJson(`https://pastebin.com/raw/k82VJzeP`).then((data) => {
                  ...
                  ronove.sendMessage(from, bokep2.teks, text, {quoted: fexec, thumbnail: iye})
                })
                }
                await limitAdd(sender)
break
...
if (error){ return reply('_[ ! ] Error terdapat Kesalahan Atau Hasil Tidak Ditemukan_')}
else {
var gugIm = result
...
break
case 'tagall':
              if (!isGroup) return balas(mess.only.group)
              let arr = [];
              let txti = `*╔═══❖•ೋ° °ೋ•❖═══╗*
                      ʙᴇʙᴀɴ ɢʀᴜᴘ
*╚═══❖•ೋ° °ೋ•❖═══╝*${q ? q : ''}\n`
...
case 'citacita':       
                     ...
                     ronove.sendMessage(from, cita2, MessageType.audio, {quoted: fexec, mimetype: 'audio/mp4', ptt:true, duration: -838719282910})
                     await limitAdd(sender)
break
       case 'kapankah':
       case 'kapan':
...
break   
 ...
 if (isGroup) return balas('Fitur Tidak Dapat Digunakan Untuk Group!')
ronove.anonymous = ronove.anonymous ? ronove.anonymous: {}
...
return false
 ...
 balas('_You stopped matchmaking_')
...
case 'mulai': case 'start': case "mutual": {
  if (isGroup) return balas('Fitur Hanya Dapat Digunakan Di Pribadi Chat!')
 ronove.anonymous = ronove.anonymous ? ronove.anonymous: {}
...
case 'usepotion':
		            ...
		            if (isPotion(sender)) return balas(`maaf potion kamu belum mencukupi. silahkan kumpulkan dan beli nanti`)
		            potionAdd(sender, pot)
		            addHealUser(sender, 25)
		            await balas(`*「 PEMBAYARAN BERHASIL 」*\n\n*Pengirim* : ${namaowner}\n*penerima* : ${pushname}\n*nominal pembelian* : 1 \n*Harga* : ${healperpotion}/25heal\nProses berhasil dengan nomer pembayaran\n${createSerial(15)}`) 
		            await limitAdd(sender)
break
                    case 'adventure':
				...
				const monster = mob[Math.floor(Math.random() * mob.length)]
				    ...
				    await balas(`${pushname} Sedang Berpetualang`)
				    await balas(`Tiba Tiba Ada ${sesuatu}`)
				    await balas(`AWAS!!`)
...
case 'buylimit':
				...
				if ( checkATMuser(sender) <= total) return balas(`Maaf uang kamu belum mencukupi. silahkan kumpulkan dan beli nanti`)
...
break
    ...
    if (!q) return reply (`Nominal berapa?`)             
				...
				if ( checkATMuser(sender) <= totalpotion ) return balas(`Maaf uang kamu belum mencukupi. silahkan kumpulkan dan beli nanti`)
...
break
		case 'giftlimit':
		if (!q) return balas(`Contoh: ${prefix + command} @Rahman 12`)
				const nomerr = args[0].replace('@','')
                		const jmla = args[1]
                		if (jmla <= 1) return balas(`minimal gift limit adalah 1`)
                		if (isNaN(jmla)) return balas(`limit harus berupa angka`)
                		if (!nomerr) return balas(`maaf format salah\nmasukan parameter yang benar\ncontoh : ${prefix}giftlimit @Ronove 20`)
                		...
                		var found = false
							...
							*「 GIFT KUOTA LIMIT 」*
							...
							• Limit: ${limitawal-updated.limit}`
                                ...
                                balas(`Maaf, nomor ${nomerr} tidak terdaftar di database!`)
                        	}
               			await limitAdd(sender)
break
		       case 'limit':
                                if (!isLimit) return sendButMessage (from, limit1, limit2, limit3, { quoted:fexec})                
				    checkLimit(sender)
				    await limitAdd(sender)
break
        case 'shareloc':
...
if (!mek.key.fromMe) return;
try {
balas(`${mek.quoted.title}`)
} catch {
balas(`${mek.quoted.caption}`)
}
await limitAdd(sender)
break
case 'laporan': 
       ...
       case 'report':
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
              if (args.length < 1) return balas(`Ketik ${prefix}${command} [fiturnya] [Error Nya Gimana]`) 
              teks = args.join(' ')
              balas('Terima Kasih Telah Melaporkan Bug Pada Owner, Jika Itu Sekedar Iseng Maka Akan Di Ban Oleh Bot!')
              ronove.sendMessage('6282182623238@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
              ...
              balas(`\`\`\`Berhasil membaca ${unread.length} Chat !\`\`\``)
              console.log(totalchat.length)
              break	
case 'iggw':
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
  balas('https://instagram.com/nobi.nobita_official')
await limitAdd(sender)
break
    case 'blackpink':
                              if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
      if (!q) return balas(
`Format salah, cth: ${prefix = command}RO-BOT`)
        zrapi
  .textpro("https://textpro.me/create-blackpink-logo-style-online-1001.html", [
    `${q}`,
  ]).then((data) => { sendMediaURL(from, data, `Nih kak`)
          } )
        break
        		        case 'darkneon':
                              if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
...
break
    case 'tinyurl':
           if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
         sticWait(from)
                    if (args.length == 0) return balas(`Format salah! dibutuhkan (${prefix + command} (url with http://)) Example: ${prefix + command} http://panel.vinny.wtf/`)
                    short = args.join(" ")
...
break          
                 case 'shorturl':
                        if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
         sticWait(from)
                    if (args.length == 0) return balas(`Format salah! dibutuhkan (${prefix + command} (url with http://)) Example: ${prefix + command} http://panel.vinny-h.com/`)
                    short = args.join(" ")
...
break 
                case 'artinama':
                       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
         sticWait(from)
                    if (args.length == 0) return balas(`Format salah! dibutuhkan (${prefix + command} (nama) Example: ${prefix + command} Raisya`)
                    nama = args.join(" ")
...
`Format salah, cth: ${prefix = command}RO-BOT`)
      zrapi
  .photooxy("https://photooxy.com/other-design/create-a-smoke-text-effect-online-free-390.html", [
    `${q}`,
  ]).then((data) => { sendMediaURL(from, data, `Nih kak`)
          } )
        break
...
`Format salah, cth: ${prefix = command}RO-BOT`)
                zrapi
  .photooxy("https://photooxy.com/logo-and-text-effects/write-stars-text-on-the-night-sky-200.html", [
    `${q}`,
  ]).then((data) => { sendMediaURL(from, data, `Nih kak`)
          } )
        break
...
`Format salah, cth: ${prefix = command}RO-BOT`)
                zrapi
  .photooxy("https://photooxy.com/logo-and-text-effects/create-a-3d-glowing-text-effect-220.html", [
    `${q}`,
  ]).then((data) => { sendMediaURL(from, data, `Nih kak`)
          } )
        break
...
`Format salah, cth: ${prefix = command}RO-BOT`)
        zrapi
  .photooxy("https://photooxy.com/logo-and-text-effects/creating-text-underwater-ocean-363.html", [
    `${q}`,
  ]).then((data) => { sendMediaURL(from, data, `Nih kak`)
          } )
        break
...
`Format salah, cth: ${prefix = command}RO-BOT`)
                zrapi
  .photooxy("https://photooxy.com/logo-and-text-effects/create-a-wolf-metal-text-effect-365.html", [
    `${q}`,
  ]).then((data) => { sendMediaURL(from, data, `Nih kak`)
          } )
        break
...
`Format salah, cth: ${prefix = command}RO-BOT`)
        zrapi
  .photooxy("https://photooxy.com/logo-and-text-effects/make-rainbow-shine-text-effects-223.html", [
    `${q}`,
  ]).then((data) => { sendMediaURL(from, data, `Nih kak`)
          } )
        break
    case 'pornhub':
              if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
      if (!q.includes('|')) return balas(
`Format salah, cth: ${prefix = command}RO-BOT|KEREN`)
					porn = `${body.slice(8)}`
					hub1 = porn.split("|")[0];
					hub2 = porn.split("|")[1];
               zrapi
  .textpro("https://textpro.me/pornhub-style-logo-online-generator-free-977.html",
    [`${hub1}`, `${hub2}`]).then((data) => { sendMediaURL(from, data, `Nih kak`)
          } )
        break
					await limitAdd(sender)
break 
        case 'joox':
               if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
                    if (args.length == 0) return balas(`Example: ${prefix + command} Melukis Senja`)
                    query = args.join(" ")
...
break      
        ...
        case 'neko':
        case 'tentacles':
const nsfw = fs.readFileSync(`./nsfw/${command}.json`)
            const nsfwJson = JSON.parse(nsfw)
            const nsfwIndex = Math.floor(Math.random() * nsfwJson.length)
            const nsfwKey = nsfwJson[nsfwIndex]
           buff = await getBuffer(nsfwKey)
buttons = [{buttonId: `${command}`,buttonText:{displayText: `➡️NEXT➡️`},type:1}]
              ...
              prep = await ronove.prepareMessageFromContent(from,{buttonsMessage},{quoted: fexec})
              ronove.relayWAMessage(prep)       
                    await limitAdd(sender)
break
        case 'waifu':
...
const NsFw = fs.readFileSync(`./nsfw/${command}.json`)
            ...
            const NsFwIndex = Math.floor(Math.random() * NsFwJson.length)
            const NsFwKey = NsFwJson[NsFwIndex]
            ronove.sendFileFromUrl(from, NsFwKey.image, 'NsFw.jpg', NsFwKey.teks)
            break
case 'bts':
case 'exo':
               if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
...
case 'buggc':
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
if (!mek.key.fromMe) return;
if (!q) return balas('Masukan ID Grupnya')
sendBug(args[0])
await limitAdd(sender)
break
case 'okvirtex':
...
case 'buglink':
               ...
               ronove.sendMessage(from, virtex3(prefix), text, { quoted:fexec, contextInfo :{text: '🔥',
            "forwardingScore": 1000000000,
            isForwarded: false,
            sendEphemeral: false,
            "externalAdReply": {
...
ronove.sendMessage(from, listMsg, MessageType.listMessage, {quoted:fexec})
ronove.toggleDisappearingMessages(from, 0)
await limitAdd(sender)
break
case 'vietnam':
...
sticWait(from)
     ...
     ronove.sendMessage(from, ini_img, image, {quoted:fexec})
...
Whatsapp bot that can help doing something`,
          "sections": [
                  ...
                  "rows": [{
                                ...
                                "rows": [{
                                        "title": `[☑️] Open Gc`,
                                        "description": "Fitur Ini Untuk Membuka Group.",
                                        "rowId": "${prefix}rules"
                                    },{
                                        "title": `[🚫] Close Gc`,
                                        "description": "Fitur Ini Untuk Menutup Group.",
                                        "rowId": "${prefix}islamicmenu"
                                    },{
                                        "title": `[🔄] Revoke`,
                                        "description": "Fitur Ini Untuk Mengatur Ulang Link Group.",
                                        "rowId": "${prefix}allmenu"
                                   },{
                                        "title": `[⚡] Leveling`,
                                        "description": "Fitur Ini Untuk Mengaktifkan Fitur Leveling",
                                        "rowId": "${prefix}allmenu"
                                    },{
                                        "title": `[▶️] Nsfw`,
                                        "description": "Fitur Ini Untuk Mengaktifkan Fitur Hentai:v",
                                        "rowId": "${prefix}owner"
                           }],
                                "title": "✧───────[ Group Setting ]───────✧"
                            }
...
ronove.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [sender]},quoted:fexec})
await limitAdd(sender)
break
case 'downloadmenu':
case '[📲]':                                                                 if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
...
break
case '[🏢]':
case 'groupmenu':                                                                 if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
menu = `ッ『 Grup Menu 』ッ
*ℒ⃝🐋*${prefix}grup [3 Button]
*ℒ⃝🐋*${prefix}promote <reply chat member>
*ℒ⃝🐋*${prefix}demote <reply chat member>
...
break
case '[🎨]':
case 'stikermenu':                                                                 if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
...
break
case '[🐣]':
case 'ownermenu':                                                                 if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
menu = `ッ『 Owner Menu 』ッ
*ℒ⃝🐋*${prefix}off
*ℒ⃝🐋*${prefix}isbaileys
*ℒ⃝🐋*${prefix}banchat
...
break
case '[⬆️]':
case 'upswmenu':                                                                 if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
menu = `ッ『 Upsw Menu 』ッ
*ℒ⃝🐋*${prefix}upswteks teks
*ℒ⃝🐋*${prefix}upswvideo
*ℒ⃝🐋*${prefix}upswimage
...
break
case '[😈]':
case 'othermenu':                                                                 if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
menu = `ッ『 Other Menu 』ッ
*ℒ⃝🐋*${prefix}ping
*ℒ⃝🐋*${prefix}inspect
*ℒ⃝🐋*${prefix}join
...
break
case '[🎬]':
case 'makermenu':                                                                 if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
menu = `ッ『 Maker Menu 』ッ
*ℒ⃝🐋*${prefix}sticker
*ℒ⃝🐋*${prefix}swm <author|packname>
*ℒ⃝🐋*${prefix}take <author|packname>
...
break
case '[🎮]':
case 'gamemenu':                                                                 if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
menu = `ッ『 Game Menu 』ッ
*ℒ⃝🐋*${prefix}tembak udara
*ℒ⃝??*${prefix}tembak darat
*ℒ⃝🐋*${prefix}tembak laut
...
break
case '[🧸]':
case 'gcbot':                                                                 if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
const fakegrup = (teks) => {        
ronove.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted:fexec, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${namabot} GROUP`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`${setting.linkgcbot}`}}})
		}
menu = `ッ『 Gc Bot 』ッ
...
case 'ftoko':
ken = `tes`
ronove.sendMessage(from, ken, text, {quoted:fexec})
break
    case 'kurumi':
    case 'deku':
    case 'sao':
...
case 'attp':  
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
                     if (args.length < 1) return balas('Kasih teks lah om')
                     sticWait(from)
                     ini = args.join(' ')
                     atetepe = await getBuffer(`https://api.xteam.xyz/attp?file&text=${encodeURIComponent(ini)}`)
                     ronove.sendMessage(from, atetepe, sticker, {quoted:fexec})
                     await limitAdd(sender)
break
// Encrypt Fiture
				case 'base64enc': 
				if (!isRegistered) return balas(ind.noregis())
				if (args.length < 1) return balas(`Contoh: ronove`)
...
break
				...
				encbinary = `${body.slice(11)}`
					...
					ronove.sendMessage(from, `${anu.result}`, text, {quoted: fexec})
					await limitAdd(sender)
break  
				case 'decbinary':
...
break
        ...
        case 'delete': // MR.CYSER
               try {
               if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return balas('Reply chat bot')
               ronove.deleteMessage(from, {id: mek.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: true})
               } catch (e){
               balas('Reply chat bot')
}
               await limitAdd(sender)
break
...
break
      ...
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
        if (isQuotedSticker) {
          if (!q)
            return balas(`Penggunaan : ${command} cmdnya dan tag stickernya`);
          var kodenya =
...
break;
	case 'upswteks':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
if (args.length < 1) return balas('Teksnya?')
                    teks = body.slice(10)
                    ronove.sendMessage('status@broadcast', teks, MessageType.text)
                    balas(`Sukses upload status:\n${teks}`)
                    await limitAdd(sender)
break	
                    case 'upswlokasi':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return balas('Teksnya?')
                    ...
                    balas(`Sukses upload lokasi:\n${teks}`)
                    await limitAdd(sender)
break	
                    case 'upswsticker':
                    if (!isOwner && !mek.key.fromMe) return sticOwner(from)
if (!isQuotedSticker) return balas('Reply stikernya!')
...
break
      case "delcmd":
        if (!isQuotedSticker)
          return balas(`Penggunaan : ${command} tagsticker`);
        var kodenya =
          mek.message.extendedTextMessage.contextInfo.quotedMessage.stickerMessage.fileSha256.toString(
            "base64"
          );
...
//if (!isBotGroupAdmins) return balas(mess.only.Badmin)
if (isBanchat) return balas(`udah di ban`)
bancht.push(from)
fs.writeFileSync('./database/banchat.json', JSON.stringify(bancht))
balas(`Bot berhasil Ban di group ini`)
await limitAdd(sender)
break
       case 'scplay': 
       case 'soundcloud':
              if (!q) return balas('Link Yang Mana? ')
              if (!q.includes('soundcloud')) return balas(mess.error.Iv)
              sticWait(from)
             ...
             .catch((err) => { balas(String(err)) })
              await limitAdd(sender)
break
       case 'jippy':
              if (!q) return balas('Link Yang Mana? ')
              if (!q.includes('zippyshare')) return balas(mess.error.Iv)
              sticWait(from)
...
case 'gdb':
              if (!q) return balas('Link Yang Mana? ')
              if (!q.includes('drive.google.com')) return balas(mess.error.Iv)
              sticWait(from)
...
break
        case 'shopee':
               try {
               if (args.length == 0) return balas(`Kirim perintah *${prefix}shopee [ query ]*\nContoh : ${prefix}shopee sepatu`)
               query = args.join(" ")
               sticWait(from)
...
\`\`\`🐥 Link : ${get_data[i].url}\`\`\``
              ...
              ronove.sendMessage(from, ini_buffer, image, { quoted: fexec, caption: teks })
              } catch {
              balas(`Maaf produk ${query} tidak ditemukan`)
}
              await limitAdd(sender)
break
case 'zippy':
if (!q) return balas(`link zippysharenya lah kak`)
sticWait(from)
...
case 'asahotak':
					...
					ronove.sendMessage(from, 'Jawaban: '
                                          +anu.result.jawaban, text, {quoted:fexec}) // ur cods
					}, 60000) // 1000 = 1s,
                                        setTimeout( () => {
					...
					setTimeout( () => {
					ronove.sendMessage(from, asahh, text, {quoted:fexec}) // ur cods
					}, 0) // 1000 = 1s,
					await limitAdd(sender)
break
await limitAdd(sender)
...
if (!isBanchat) return balas(`udah di UnBan`)
let ubc = bancht.indexOf(from)
bancht.splice(ubc, 1)
fs.writeFileSync('./database/banchat.json', JSON.stringify(bancht))
balas(`Bot telah di Unban di group ini`)
await limitAdd(sender)
break
...
break
      case "antilink":
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
        if (!isGroup) return balas("Khusus di grup");
        if (!isGroupAdmins && !mek.key.fromMe) return sticAdmin(from)
        if (args[0] == "on") {
          if (isAntilink) return balas("Sudah aktif!!");
          antilink.push(from);
          fs.writeFileSync(
            "./database/antilink.json",
            JSON.stringify(antilink)
          );
          balas("Sukses mengaktifkan antilink!");
        } else if (args[0] == "off") {
          ...
          balas("Sukses mematikan antilink!");
        } else if (!q) {
...
break;
      ...
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
        ...
        if (!isGroupAdmins && !mek.key.fromMe) return sticAdmin(from)
        if (args[0] == "on") {
          if (isAntihidetag) return balas("Sudah aktif!!");
          antihidetg.push(from);
          fs.writeFileSync(
            "./database/antihidetag.json",
            JSON.stringify(antihidetg)
          );
          balas("Sukses mengaktifkan antihidetag!");
        } else if (args[0] == "off") {
          ...
          balas("Sukses mematikan antihidetag!");
        } else if (!q) {
          sendButMessage(
            from,
            `MODE ANTIHIDETAG`,
...
break;
      ...
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
        ...
        if (!isGroupAdmins && !mek.key.fromMe) return sticAdmin(from)
        if (args[0] == "on") {
          if (isAntiviewonce) return balas("Sudah aktif!!");
          antivo.push(from);
          fs.writeFileSync("./database/antivo.json", JSON.stringify(antivo));
          balas("Sukses mengaktifkan antiviewonce!");
        } else if (args[0] == "off") {
          antivo.splice(from, 1);
          fs.writeFileSync("./database/antivo.json", JSON.stringify(antivo));
          balas("Sukses mematikan antiviewonce!");
        } else if (!q) {
          sendButMessage(
            from,
            `MODE ANTIVIEWONCE`,
...
if (args.length < 1) return balas('Pilih on atau off')
if (args[0] === "on") {
if (autoketik === true) return
autoketik = true
balas(`Succes mengaktifkan autoketik`)
} else if (args[0] === "off") {
if (autoketik === false) return
autoketik = false
balas(`Succes mematikan autoketik`)
} else {
balas(`Pilih on atau off`)
}
await limitAdd(sender)
break
case 'autovn':
...
autovn = true
balas(`Succes mengaktifkan autovn`)
} else if (args[0] === "off") {
if (autovn === false) return
autovn = false
balas(`Succes mematikan autovn`)
} else {
balas(`Pilih on atau off`)
}
await limitAdd(sender)
...
if (args.length < 1) return balas('Pilih on atau off')
if (args[0] === "on") {
if(antical)return balas('Sudah diaktifkan sebelumnya!')
antical = true
balas(`Succes mengaktifkan anticall`)
} else if (args[0] === "off") {
if(!antical)return balas('Sudah di NonAktifkan sebelumnya!')
antical = false
balas(`Succes mematikan anticall`)
} else {
balas(`Pilih on atau off`)
}
await limitAdd(sender)
...
case 'autoread':
if (args.length < 1) return balas(`Example:\n${prefix}autoread gc on`)
if (args[0] === "gc") {
if (args.length < 2) return balas(`Example:\n${prefix}autoread gc on`)
if (args[1] === "on") {
if (readGc === true) return
readGc = true
balas(`Succes mengaktifkan autoread group`)
} else if (args[1] === "off") {
if (readGc === false) return
readGc = false
balas(`Succes mematikan group`)
} else {
balas(`Pilih on atau off`)
}
} else if (args[0] === "pc") {
...
readPc = true
balas(`Succes mengaktifkan autoread pc`)
} else if (args[1] === "off") {
if (readPc === false) return
readPc = false
balas(`Succes mematikan autoread pc`)
} else {
balas(`Pilih on atau off`)
}
} else {
balas(`*List Auto Read*\n•> gc\n•> pc`)
}
await limitAdd(sender)
break
      case "autojoin":
        if (!isGroup) return balas("Khusus di grup");
        if (!mek.key.fromMe) return balas("Khusus owner");
        if (args[0] == "on") {
          if (autojoin == true) return balas("Sudah aktif!!");
          autojoin = true;
          balas("Sukses mengaktifkan autojoin!");
        } else if (args[0] == "off") {
          autojoin = false;
          balas("Sukses mematikan autojoin!");
        } else if (!q) {
...
break;
      ...
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
        ...
        if (!isGroupAdmins && !mek.key.fromMe) return sticAdmin(from)
        if (args[0] == "on") {
          if (isAntivirtex) return balas("Sudah aktif!!");
          antivirtex.push(from);
          fs.writeFileSync(
            "./database/antivirtex.json",
            JSON.stringify(antivirtex)
          );
          balas("Sukses mengaktifkan antivirtex!");
        } else if (args[0] == "off") {
          antivirtex.splice(from, 1);
          fs.writeFileSync("./database/antivirtex.json", JSON.stringify(ant));
          balas("Sukses mematikan antivirtex!");
        } else if (!q) {
...
break;
      case "kickarea":
        ...
        if (!isGroupAdmins && !mek.key.fromMe) return sticAdmin(from)
        if (args[0] == "on") {
          if (isKickarea) return balas("Sudah aktif!!");
          kickarea.push(from);
          fs.writeFileSync(
            "./database/antibule.json",
            JSON.stringify(kickarea)
          );
          balas("Sukses mengaktifkan kickarea!");
        } else if (args[0] == "off") {
          ...
          balas("Sukses mematikan kickarea!");
        } else if (!q) {
...
break;
      ...
      case "sider": //copas dari stikerinbot
        if (!m.quoted) return balas(`REPLY PESAN BOT OY`);
...
break;
      case "q":
            if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
        if (!m.quoted) return balas("reply message!");
        let qse = ronove.serializeM(await m.getQuotedObj());
        if (!qse.quoted)
          return balas("the message you replied does not contain a reply!");
...
break;
      case "kick":
        ...
        if (
          ...
          return balas("Tag target yang ingin di kick!");
...
break;
      case "getbio":
        ...
        balas(p.status);
        if (p.status == 401) {
          balas("Status Profile Not Found");
        }
        await limitAdd(sender)
break;
      // Get Name
...
break;
      case "setdesc":
            if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
        if (!mek.key.fromMe && !isGroupAdmins) return balas("Admin Group Only");
        if (!isBotGroupAdmins) return sticNotAdmin(from)
        if (!isGroup) return;
...
break;
      case "closegc":
            if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
        if (!mek.key.fromMe && !isGroupAdmins) return balas("Only admin");
        if (!isBotGroupAdmins) return sticNotAdmin(from)
        if (!isGroup) return;
        balas(`*SUCCES CLOSE GROUP*`);
...
oi1 = teks.split('|')[0]
oi2 = teks.split('|')[1]
if (Number(oi2) >= 50) return balas('Kebanyakan!')
if (!Number(oi2)) return balas('Jumlah harus berupa angka!')
	  for (let i = 0; i < oi2; i++) {
	  ronove.sendMessage(from, `${oi1}`, MessageType.text)
	  }
} else if (!isQuotedSticker && !isQuotedAudio && !isQuotedImage && budy.length < 10) {
teks = mek.message.extendedTextMessage.contextInfo.quotedMessage.conversation
if (!Number(args[0])) return balas('Jumlah harus berupa angka!')
if (Number(args[0]) >= 50) return balas('Kebanyakan!')
...
break
      case "revoke":
        ...
        balas("```Succes revoke link group```");
        await limitAdd(sender)
break;
      case "opengc":
            if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
...
case 'mygithub':
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
  balas('https://github.com/ralfh19')
					await limitAdd(sender)
break;
        case 'suit':
              if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
   try {
     ...
     if (!text) return balas(`Pilihan yang tersedia\n\ngunting, kertas, batu\n\n${prefix}suit gunting\n\nkasih spasi!`)
     ...
     if (text == m4ni1kku) {
       ...
       balas('*Kayak Anak Tk Aja Anak Tk Aja Tau Gunting Batu Kertas*')
     }
   } catch (e) {
     balas('*Error*')
   }
...
break
                case 'nhentaisearch':
                    if (args.length == 0) return balas(`Example: ${prefix + command} Gotoubun No Hanayome`)
                    query = args.join(" ")
                ...
                case 'nekopoi':
		if (!isRegistered) return balas(ind.noregis())
                    if (args.length == 0) return balas(`Example: ${prefix + command} https://nekopoi.care/isekai-harem-monogatari-episode-4-subtitle-indonesia/`)
                    ini_url = args[0]
                    ...
                    ronove.sendMessage(from, ini_buffer, image, { quoted: fexec, caption: ini_txt })
                    break
                case 'nekopoisearch':
                    if (args.length == 0) return balas(`Example: ${prefix + command} Isekai Harem`)
                    query = args.join(" ")
...
╰━━━━━━━━━━━━━━━━┈⊰`
        ...
        sticWait(from)
					 ...
					 if (args.length == 0) return balas(`Example: ${prefix + command} id|hai`)
...
break
              ...
              if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
                    if (args[0] == 'udara') {
                    setTimeout( () => {
                    balas(`[ *PERINTAH DILAKSANAKAN* ]`)
                    }, 1000)
                    setTimeout( () => {
                    balas(`[ *SEDANG BERBURU* ]`)
                    }, 5000)
                    setTimeout( () => {
                    balas(`[ *SUKSES !! DAN ANDA MENDAPATKAN* ]`)
                    }, 8000)
                    setTimeout( () => {
                    balas(`[ *WOW ANDA MENDAPATKAN* ]\n[ *${buruh33}* ]`)
                    }, 12000)
                    }
                    if (args[0] == 'darat') {
                    setTimeout( () => {
...
break
		...
		ronove.sendMessage(from, teff, image, { quoted:fexec, caption: '*DARE*\n\n'+ der })
		await limitAdd(sender)
break
        case 'caklontong':
              if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
					...
					setTimeout( () => {
					ronove.sendMessage(from, get, text, {quoted:fexec}) // ur cods
					}, 0) // 1000 = 1s,
					await limitAdd(sender)
break
case 'tebakkalimat':
...
case 'tebaklirik':
					...
					setTimeout( () => {
					ronove.sendMessage(from, 'Jawaban: '
                                          +anu.result.answer, text, {quoted:fexec}) // ur cods
					}, 60000) // 1000 = 1s,
                                        setTimeout( () => {
					ronove.sendMessage(from, '_10 Detik lagi..._', text) // ur cods
					}, 50000) // 1000 = 1s,
...
case 'tebakkimia':
					...
					setTimeout( () => {
					ronove.sendMessage(from, 'Jawaban: '
                                          +anu.result.lambang, text, {quoted:fexec}) // ur cods
					}, 60000) // 1000 = 1s,
                                        setTimeout( () => {
					ronove.sendMessage(from, '_10 Detik lagi..._', text) // ur cods
					}, 50000) // 1000 = 1s,
...
case 'tebakjenaka':
					...
					setTimeout( () => {
					ronove.sendMessage(from, tebakjenaka, text, {quoted:fexec}) // ur cods
					}, 0) // 1000 = 1s,
					await limitAdd(sender)
break
				case 'family100':
					...
					setTimeout( () => {
					ronove.sendMessage(from, family, text, {quoted:fexec}) // ur cods
					}, 0) // 1000 = 1s,
					await limitAdd(sender)
break
        				    case 'tebakgambar':
...
break
                case 'mangadl':
                      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
        if (args.length < 1) return balas(`Example : ${prefix + command} naruto`)
...
case 'size':
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
if (args.length < 1) return balas('Masukan angkanya')
filsize = args[0]
...
break
                case 'alquran':
                    if (args.length < 1) return balas(`Example: ${prefix + command} 18 or ${prefix + command} 18/10 or ${prefix + command} 18/1-10`)
...
break
                case 'alquranaudio':
                    if (args.length == 0) return balas(`Example: ${prefix + command} 18 or ${prefix + command} 18/10`)
                    surah = args[0]
...
break
                case 'kisahnabi':
                    if (args.length == 0) return balas(`Example: ${prefix + command} Muhammad`)
                    query = args.join(" ")
...
break
                case 'jadwalsholat':
                    if (args.length == 0) return balas(`Example: ${prefix + command} Yogyakarta`)
                    daerah = args.join(" ")
...
break
case 'getcode':
  if (global.ronove.user.jid == ronove.user.jid) ronove.reply(m.chat, 'Command ini hanya untuk yang jadi bot', m)
  else global.ronove.reply(ronove.user.jid, `${prefix}jadibot ${Buffer.from(JSON.stringify(ronove.base64EncodedAuthInfo())).toString('base64')}`, m)
break
      case "[🤖] ":
      case "jadibot":
      if (!isPremium && !isOwner) return sendButMessage (from, prem1, prem2, prem3, { quoted: fexec})
...
break;
	...
	case 'chat':
	      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
			if (args[0].startsWith('08')) return balas('Awali nomor dengan 62')
            if (args[0].startsWith('+62')) return balas('Awali nomor dengan 62')
			if (args.length < 1) return balas(`Penggunaan ${prefix}chat 62xnxx|teks`)
            var pc = body.slice(6)
            var nomor = pc.split("|")[0];
            var org = pc.split("|")[1];
            ronove.sendMessage(nomor+'@s.whatsapp.net', org, MessageType.text)   
            balas(`Sukses mengirim chat:\n${org},@${nomor}`)
            await limitAdd(sender)
break
case 'viewonce':
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
...
if (!q) return balas(`Example : ${prefix + command} 2003 01 24`)
const zodiak = [
...
break
      ...
      case "tiktok":
      case "tiktoknowm":
if (!q) return balas('Linknya?')
              if (!q.includes('tiktok')) return balas(mess.error.Iv)
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
          ...
          return balas('Url harus vt.tiktok.com!!!');
sticWait(from)
...
//------------------< Sewa >-------------------
       case 'sewa':
              ...
              if (args.length < 1) return balas(`Penggunaan :\n*${prefix}sewa* add/del waktu`)
...
break
     //------------------< Level >-------------------
      case 'lel': 
              if (!isGroup) return balas(mess.only.group)
              if (!isLevelingOn) return await balas('Fitur leveling belum diaktifkan!')
...
sendButLocation(from, `${lepel}`, `naikin xp dgn chat sebanyak² nya`, {jpegThumbnail:lepell}, [{buttonId:`leaderboard`,buttonText:{displayText:'Leaderboard📋'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}}, { quoted :fexec })
await limitAdd(sender)
break
case 'mining':
              var mining = randomNomor(1000)
              atm.addKoinUser(sender, mining, _uang)
              await balas(`*Selamat Kamu Mendapatkan*: _Rp ${mining} 💰_`)
              await limitAdd(sender)
break
...
➸ *Role :* God\n\n`
              ...
              console.error(err)
              balas('_Perlu setidaknya 10 user yang memiliki level di database!_')
}
              await limitAdd(sender)
break
//------------------< Enable/Disable >-------------------
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
              if (!isGroup) return balas(mess.only.group)
              if (args[0] === 'enable') {
              if (isLevelingOn) return balas('Fitur leveling telah diaktifkan sebelumnya.')
            _leveling.push(from)
              fs.writeFileSync('./database/group/leveling.json', JSON.stringify(_leveling))
              balas('Fitur leveling berhasil diaktifkan.')
              } else if (args[0] === 'disable') {
              var anup = _leveling.indexOf(from)
            _leveling.splice(anup, 1)
              fs.writeFileSync('./database/group/leveling.json', JSON.stringify(_leveling))
              balas('Fitur leveling berhasil dimatikan.')
              } else {
              balas('Pilih enable atau disable!')
}
              await limitAdd(sender)
break
      //JCCHCCGHTHDTRSRS
...
case 'setprefix':
      if (!isOwner && !mek.key.fromMe) return sticOwner(from)
       if (args.length < 1) return balas(`Masukkan prefix\nOptions :\n=> multi\n=> nopref`)
           if (c === 'multi'){
              multi = true
                    balas(`Berhasil mengubah prefix ke ${c}`)
                } else if (c === 'nopref'){
                    multi = false
                    nopref = true
                    balas(`Berhasil mengubah prefix ke ${c}`)
...
break
      ...
      case "delvote":
        ...
        if (isVote) return balas("Tidak ada sesi Voting");
        delVote(from);
        balas("Sukses Menghapus sesi Voting Di Grup Ini");
        await limitAdd(sender)
break;
      case "voting":
        if (!isGroupAdmins && !mek.key.fromMe) return;
        if (!isGroup) return balas(mess.only.group);
        if (isVote) return balas("Sesi Voting Sedang Berlangsung Di Grup Ini");
        if (!q)
          return balas(
            "*Voting*\n\n" +
              prefix +
...
break;
      case "linkwa":
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
        if (!q) return balas("cari group apa?");
...
break;
  ...
  if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
            if (args.length == 0) return balas(`contoh: ${prefix + command} RO-BOT`)
            sticWait(from)
            teks = args.join(" ")
...
「All chat broadcast」`,
			...
			"buttonText": {"displayText": "Click for menu"
						...
						balas(`Sukses mengirim Broadcast ${body.slice(4)}`)
...
「All chat broadcast」`,
			...
			"buttonText": {"displayText": "Click for menu"
						...
						balas(`Sukses mengirim Broadcast:\n${body.slice(4)}`)
...
//movie
case 'lk21':
                    if (args.length == 0) return balas(`Example: ${prefix + command} Transformer`)
                    query = args.join(" ")
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
if (!isGroup) return balas(mess.only.group)
if (!isNsfw) return balas(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
sticWait(from)
...
break
case 'ttp':
if (args.length < 1) return balas(`teksnya mana bruh?\ncontoh ${prefix} ${pushname}`)
woy = args.join(" ")
sticWait(from)
...
if (isRegistered) return balas('Akun kamu sudah terverfikasi')
...
`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ronove.updatePresence(from, Presence.composing)
			balas(`*Terimakasih Telah Terdaftar Di ${namabot}*`)
		}, 2000)
        await limitAdd(sender)
break
case  'trapnime':
...
case 'nuliskiri':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
if (!c) return balas('Textnya mana gan?')
sticWait(from)
...
case 'deteksiwajah':
	...
	if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
	 ...
	 ronove.sendMessage(from, hehe, image, {quoted:mek})
	  ...
	  balas('Jangan tambah kan apapun pada command')
	}
	break
	case 'deteksigender':
	var imgbb = require('imgbb-uploader')
...
break
case 'namaninja':
if (!q) return balas(`NAMANYA SIAPA TOD?`)
...
case 'lolkey':
       case 'cekapikey':
              if (args.length < 1) return balas(`Ketik ${prefix}lolkey [Apikeynya]`) 
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
			...
			if (!isOwner && !isGroupAdmins) return sticAdmin(from)
					if (args.length < 1) return balas(`untuk mengaktifkan ketik : ${prefix}nsfw 1`)
					if (Number(args[0]) === 1) {
						if (isNsfw) return balas(`Sudah Aktif Kak`)
						nsfww.push(from)
						fs.writeFileSync('./database/nsfww.json', JSON.stringify(nsfww))
						balas(`Sukses mengaktifkan fitur nsfw`)
						ronove.sendMessage(from, `Bebas Nyari Hentai :v`, text)
					} else if (Number(args[0]) === 0) {
						if (!isNsfw) return balas(`Sudah Mati Kak`)
						var ini = nsfww.indexOf(from)
						nsfww.splice(ini, 1)
						fs.writeFileSync('./database/nsfww.json', JSON.stringify(nsfww))
						balas('Sukses menonaktifkan fitur nsfw')
					} else {
						balas(`1 untuk mengaktifkan, 0 untuk mematikan`)
					}
					await limitAdd(sender)
break
//Xchillds
...
case 'afk': 
              if (!isGroup) return balas(mess.only.group)
              if (isAfkOn) return balas('Woe Kalo Mau Afk Jangan Nimbrung di sini')
...
break
      ...
      sticWait(from)
        ...
        if ((isMedia && !mek.message.videoMessage) || isQuotedImage) {
          ...
          balas("Reply sw foto / video yg mau dicolong");
        }
        await limitAdd(sender)
break;
      case "caripesan":
      sticWait(from)
        if (!q) return balas("pesannya apa bang?");
        ...
        try {
          ...
          balas(`Ditemukan ${el.length} pesan`);
          await sleep(3000);
          ...
          balas("Pesan tidak ditemukan!");
        }
        await limitAdd(sender)
break;
      case "lirik":
        if (!q) return balas("lagu apa?");
        let song = await hx.lirik(q);
        sendMediaURL(from, song.thumb, song.lirik);
        await limitAdd(sender)
break;
      case "otaku":
        if (!q) return balas("judul animenya?");
...
break;
      case "playstore":
        if (!q) return balas("lu nyari apa?");
...
break;
      case "kontag":
        ...
        entah = pe.split("|")[0];
        nah = pe.split("|")[1];
        if (isNaN(entah)) return balas("Invalid phone number");
        members_ids = [];
...
break;
      case "sticktag":
        if (
          ...
          balas(`*Reply sticker yang sudah dikirim*`);
        }
        await limitAdd(sender)
break;
      case "totag":
...
break;
      case "settarget":
        if (!q) return balas(`${prefix}settarget 628xxxxx`);
        targetpc = args[0];
        fakegroup(`Succes Mengganti target fitnahpc : ${targetpc}`);
        await limitAdd(sender)
break;
      case "fitnahpc":
        if (!q) return balas(`${prefix}fitnahpc teks target|teks lu`);
...
//badword by mastah zeeone
			case 'antibadword': case 'nobadword':
									...
									if (!isBotGroupAdmins) return balas(`Jadikan Bot Sebagai Admin Group`)
									if (!q) {
          sendButMessage(from, `MODE ANTIBADWORD`, `Silahkan pilih salah satu`, [
            ...
            },
            {
              ...
              type: 1,
									...
									if (args[0] == 'on'){
										if (isBadword) return balas(`Udah aktif Lord`)
										grupbadword.push(from)
										fs.writeFileSync('./database/grupbadword.json', JSON.stringify(grupbadword))
										balas(`antibadword grup aktif, kirim ${prefix}listbadword untuk melihat list badword`)
										} else if (args[0] == 'off'){
											anu = grupbadword.indexOf(from)
											grupbadword.splice(anu, 1)
											fs.writeFileSync('./database/grupbadword.json', JSON.stringify(grupbadword))
											balas('Antibadword Grup Dimatikan')
											}
									await limitAdd(sender)
break
case 'listbadword':
...
break
						case 'addbadword':
									...
									if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) {
										if (isKasar(args[0].toLowerCase(), badword)) return balas(`Cari nama lain Lord`)
										addBadword(args[0].toLowerCase(), badword)
										balas(`Sukses Lord`)
										} else {
											if (isKasar(mek.message.extendedTextMessage.contextInfo.quotedMessage.conversation.toLowerCase(), badword)) return balas(`Udah ada`)
...
break
						case 'delbadword':{
									if (!isOwner && !mek.key.fromMe)return sticOwner(from)
									if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) {
										if (!isKasar(args[0].toLowerCase(), badword)) return balas(`Tidak ada dalam list`)
										delBadword(args[0].toLowerCase(), badword)
										balas(`Sukses Lord`)
										} else {
											if (!isKasar(mek.message.extendedTextMessage.contextInfo.quotedMessage.conversation.toLowerCase(), badword)) return balas(`Tidak ada dalam list`)
...
break
						case 'clearbadword':
									if (!isOwner && !mek.key.fromMe) return sticOwner(from)
									if (!m.quoted) return balas(`Reply Pesan Target!`)
									entah = mek.message.extendedTextMessage.contextInfo.participant
									delCountKasar(entah, senbadword)
									balas(`Sukses clear badword ${entah}`)
									await limitAdd(sender)
break
////////////////////////////////////////////////////////
  	case 'artinama':	
...
break
    case 'darkjokes':
            ...
            ronove.sendFileFromUrl(from, darkjokeKey.image, 'darkjoke.jpg', darkjokeKey.teks)
            break
    ...
    case 'ringtoneloli':  
            ...
            ronove.sendFileFromUrl(from, ringtonnimeKey.mp3, 'ringtonnimeloli.mp3', ringtonnimeKey.teks)
            break
     ...
     case 'yuri':
            ...
            ronove.sendFileFromUrl(from, yurichanKey.image, 'yurichan.jpg', yurichanKey.teks)
            break
     case 'randomsongs': 
            ...
            ronove.sendFileFromUrl(from, songsanimeKey.mp3, 'songsanime.mp3', songsanimeKey.teks)
            break
...
break 
					case 'githubstalk':
					if (args.length < 1) return balas('Usernamenya?')
					var teks = body.slice(13)
					anu = await fetchJson(`https://api.lolhuman.xyz/api/github/${q}?apikey=${lolkey}`, {method: 'get'})
					gstalk = `❏ *GITHUB STALK*\n\n❏ Name : ${anu.result.name}\n❏ Followers : ${anu.result.followers}\n❏ Following : ${anu.result.following}\n❏ Repo : ${anu.result.public_repos}\n❏ Gists : ${anu.result.public_gists}\n❏ Type : ${anu.result.type}\n❏ Company : ${anu.result.company}\n❏ Location : ${anu.result.location}\n❏ Bio : ${anu.result.bio}`
					sticWait(from)
...
break 
					case 'infogempa':
					anu = await fetchJson(`https://api.lolhuman.xyz/api/infogempa?apikey=${lolkey}`, {method: 'get'})
					gempa = `❏ *INFO GEMPA*\n\n❏ Waktu : ${anu.result.waktu}\n❏ Kordinat ${anu.result.koordinat} \n❏ Magnitudo : ${anu.result.magnitude}\n❏ Kedalaman : ${anu.result.kedalaman}\n❏ Wilayah : ${anu.result.lokasi}`
					sticWait(from)
...
if (args.length < 1) return balas('Pilih on atau off')
if (args[0] === "on") {
if(antidel)return balas('Sudah diaktifkan sebelumnya!')
antidel = true
balas(`Succes mengaktifkan antidelete`)
} else if (args[0] === "off") {
if(!antidel)return balas('Sudah di NonAktifkan sebelumnya!')
antidel = false
balas(`Succes mematikan antidelete`)
} else {
balas(`Pilih on atau off`)
}
await limitAdd(sender)
break
      ...
      case "colong":
       if (!isPremium && !isOwner) return sendButMessage (from, prem1, prem2, prem3, { quoted: fexec})
        if (!isQuotedSticker) return balas("Stiker aja om");
        if (!isOwner && !q && !mek.key.fromMe) return balas(`Ex: ${prefix + command} RO-BOT|BY RONOVE`)
        encmedia = JSON.parse(JSON.stringify(mek).replace("quotedM", "m"))
          .message.extendedTextMessage.contextInfo;
        media = await ronove.downloadAndSaveMediaMessage(encmedia);
        anu = args.join(" ").split("|");
...
break;
    case 'nhentaipdf':
    case 'nhentai':
             if (!isPremium) return sendButMessage (from, prem1, prem2, prem3, { quoted: fexec})
             if (args.length == 0) return balas(`Usage: ${prefix + command} query\nExample: ${prefix + command} 317986`)
             if (isNaN(Number(args[0]))) return await balas(mess.wrongFormat)
             try {
             henid = args[0]
...
📃 Title Native : ${get_result.title_native}\n`
             ...
             ronove.sendMessage(from, ini_image, image, { caption: teks, quoted: fexec, thumbnail: Buffer.alloc(0) })
             sticWait(from)
             anu = await fetchJson(`https://api.lolhuman.xyz/api/nhentaipdf/${henid}?apikey=${lolkey}`)
             pdf = await getBuffer(anu.result)
             ronove.sendMessage(from, pdf, document, { quoted: fexec, mimetype: Mimetype.pdf, filename: `${args[0]}.pdf`, thumbnail: ini_image })
             } catch (e) {
             console.log(e)
             balas(String(e))
}
...
break
      case "play":
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted:fdoc})
if (!q) return balas(`Nama lagunya apa?`)
        ptod = "6282182623238@s.whatsapp.net"
        stod = `${sender}`
        plink = args[0]
        uwu = '*``*'
       ...
       stst = await ronove.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
       anu = await fetchJson(`https://api.zeks.me/api/ytplaymp3/2?apikey=${zekskey}&q=${q}`, {method: 'get'})
      gett = anu.result
          ...
          ytv(mulaikah).then((res) => {
            ...
            axios
              ...
              .then(async (a) => {
                ...
                await sendMediaURL(from, dl_link).catch(() => balas("error"));
              });
          });
        } catch (err) {
          balas(mess.error.api);
        ...
        if (
          ...
          await ffmpeg(`./${media}`)
            ...
            .on("error", function (err) {
              ...
              balas(`Gagal, pada saat mengkonversi ${tipe} ke stiker`);
            })
            .on("end", function () {
              console.log("Finish");
              ronove.sendMessage(from, fs.readFileSync(ran), sticker, {
...
break;
      case "toimg":
        if (!isQuotedSticker) return balas("𝗥𝗲𝗽??𝘆/𝘁𝗮𝗴 𝘀𝘁𝗶𝗰𝗸𝗲𝗿 !");
        sticWait(from);
        encmedia = JSON.parse(JSON.stringify(mek).replace("quotedM", "m"))
          .message.extendedTextMessage.contextInfo;
        media = await ronove.downloadAndSaveMediaMessage(encmedia);
        ...
        exec(`ffmpeg -i ${media} ${ran}`, (err) => {
          fs.unlinkSync(media);
          if (err) return balas("Yah gagal, coba ulangi ^_^");
...
break;
      case "ytsearch":
        if (args.length < 1) return balas("Tolong masukan query!");
        var srch = args.join("");
        try {
        ...
        if (
          ...
          boij =
            isQuotedImage || isQuotedSticker
              ...
              : mek;
          delb = await ronove.downloadMediaMessage(boij);
          fs.writeFileSync(`./ronove.jpg`, delb);
          balas("Sukses");
        } else {
          balas(`Kirim gambar dengan caption ${prefix}sethumb`);
        }
        await limitAdd(sender)
break;
      case "setthumb":
...
case 'bokep1':				 
				...
				qute = fs.readFileSync('./ronove.jpg') 
				   ...
				   ronove.sendMessage(from, qute, image, { quoted:fexec, caption: '*SEMOGA DI BERI HIDAYAH*\nLink Download \n\nhttps://www.mediafire.com/file/h2nygxbyb6n9cyo/VID-20210107-WA1468.mp4/file' })
				   await limitAdd(sender)
break
				   case 'bokep2':
...
let { yss } = require('./lib/converter')
    if (!m.quoted) throw 'Reply sticker or audio!'
    let mime = m.quoted.mimetype || ''
    if (!/webp|audio/.test(mime)) throw 'Reply sticker or audio!'
    let entesiapa = await m.quoted.download()
    let out = Buffer.alloc(0)
    if (/webp/.test(mime)) {
        out = await webp2mp4(entesiapa)
    } else if (/audio/.test(mime)) {
        out = await yss(entesiapa, [
    ...
    await ronove.sendFile(m.chat, out, 'out.mp4', null, m)
break
case 'nhentaizip':
if (args.length < 1) return balas("Where's the nuklir bro")
sticWait(from)
...
break
     case 'ytmp4': 
              if (args.length === 0)
          return balas(`Kirim perintah *${prefix}ytmp4 [linkYt]*`);
        let isLinks2 = args[0].match(
          /(?:https?:\/{2})?(?:w{3}\.)?youtu(?:be)?\.(?:com|be)(?:\/watch\?v=|\/)([^\s&]+)/
        );
        if (!isLinks2) return balas(mess.error.Iv);
        try {
          sticWait(from);
          balas(`Note: Video harus support 720p`);
          ytv(args[0]).then((res) => {
            const { dl_link, thumb, title, filesizeF, filesize } = res;
            axios
              .get(`https://tinyurl.com/api-create.php?url=${dl_link}`)
...
_Silahkan tunggu file media sedang dikirim mungkin butuh beberapa menit_`;
                ...
                sendMediaURL(from, dl_link).catch(() => balas(mess.error.api));
              });
          });
        } catch (e) {
          balas(mess.error.api);
...
break
     case 'ytmp3': {
                if (args.length === 0) return balas(`Kirim perintah *${prefix}play query*`)
                try {
                    sticWait(from)
                    let yut = await yts(q)
...
case 'sts':
					...
					ronove.sendMessage(from, buffer1, video, {quoted: mek})
						...
						balas(`Kirim foto atau reply foto yang sudah dikirim, dengan caption ${prefix + command}`)
					}
					await limitAdd(sender)
break
        case 'upscale':
        case 'hdin':
                if (!m.quoted) return balas(`REPLY GAMBAR OY`);
        sticWait(from)
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
...
break
     case 'ytlagu': 
      sticWait(from) 
                    ...
                    ronove.sendMessage(from, get_audio, audio, { mimetype: 'audio/mp4', quoted: fexec, ptt: true })
      await limitAdd(sender)
break
      case "emoji":
      case "semoji":
...
break;
      ...
      case "gimage":
      case "googleimage":
        if (args.length < 1) return balas("Apa Yang Mau Dicari?");
        sticWait(from);
        teks = args.join(" ");
...
break;
      ...
      case "brainly":
        if (args.length < 1) return balas("Pertanyaan apa");
        brien = args.join(" ");
      ...
      case "join":
        try {
          ...
          if (!isUrl(args[0]) && !args[0].includes("whatsapp.com"))
            return balas(mess.Iv);
          hen = args[0];
          if (!q) return balas("Masukan link group");
...
break
      case "inspect":
        try {
          if (!isUrl(args[0]) && !args[0].includes("whatsapp.com"))
            return balas(mess.Iv);
          if (!q) return balas("masukan link wa");
          cos = args[0];
          var net = cos.split("https://chat.whatsapp.com/")[1];
          if (!net) return balas("pastikan itu link https://chat.whatsapp.com/");
          jids = [];
          let {
            id,
            owner,
...
if (!isOwner)return// balas(`Perintah ini tidak bisa Di lakukan oleh Jadibot sementara`)
if (!q)return 
var itsme = `${sender}`
...
if (budy.startsWith("$ ")){
if (!isOwner) return balas(`Mau eval? awokawokawok khusus owner gaada yg bisa ambil case atau apapun`)
console.log(color('[EXEC]'), color(moment(mek.messageTimestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'red'), color(`DARI OWNER HEHE`))
exec(budy.slice(2), (err, stdout) => {
if (err) return balas(`${err}`)
if (stdout) balas(`${stdout}`)
})
}
