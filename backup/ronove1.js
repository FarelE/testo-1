...
`
                    ...
                    ronove.sendMessage(from, { contentText: `${menu}`, footerText: `╔════════════════════\n║╭──❲ *INFO BOT* ❳\n║│${ly} Nama: ${namabot}\n║│${ly} Prefix: 「 Multi 」\n║│${ly} Author:  ${namaowner}\n║╰────────────────\n╠═══❲ *INFO PENGGUNA* ❳════\n║╭────────────────\n║│${ly} Nama: ${pushname}\n║│${ly} Nomer: wa.me/${sender.split("@")[0]}\n║│${ly} Xp : ${Xpluu} / ${requiredXplu}\n║│${ly} Rank: ${role}\n║│${ly} Level : ${Levelnye}\n║│${ly} Uang : ${checkATMuser(sender)}\n║│${ly} Premium : ${isPremium ? 'Ya' : 'No'}\n║╰────────────────\n╠═════❲ *LIST MENU* ❳══════\n║╭────────────────\n║│${ly} ${prefix}groupmenu\n║│${ly} ${prefix}ownermenu\n║│${ly} ${prefix}nsfwmenu\n║│${ly} ${prefix}gamemenu\n║│${ly} ${prefix}downloadmenu\n║│${ly} ${prefix}stalkmenu\n║│${ly} ${prefix}stickermenu\n║│${ly} ${prefix}islamimenu\n║│${ly} ${prefix}cekmenu\n║│${ly} ${prefix}gachacecan\n║│${ly} ${prefix}othermenu\n║│${ly} ${prefix}kerangmenu\n║│${ly} ${prefix}makermenu\n║│${ly} ${prefix}stickermenu\n║│${ly} ${prefix}upswmenu\n║│${ly} ${prefix}ownermenu\n║│${ly} ${prefix}wibumenu\n║╰────────────────\n║╭────────────────\n║│${ly} ${prefix}limit\n║│${ly} ${prefix}potion\n║│${ly} ${prefix}heal\n║│${ly} ${prefix}timer\n║╰──────────────────\n╠═════❲ *INFO BOT* ❳══════\n║╭────────────────\n║│${ly} Nama Bot : ${namabot}\n║│${ly} Server : ${ronove.browserDescription[0]}\n║│${ly} Ram : ${RAM}\n║│${ly} MCC : ${mcc} \n║│${ly} MNC : ${mnc} \n║│${ly} Versi Os : ${os_version} \n║│${ly} Versi Hp : ${device_model} \n║│${ly} Merk Hp : ${device_manufacturer}\n║│${ly} WhatsApp : ${wa_version}\n║│${ly} Total Hit : ${totalhit} Hit\n║│${ly} Hit Today: ${hit_today.length} Hit\n║╰──────────────────\n╚════════════════════`, buttons: [{ buttonId: `rules`, buttonText: { displayText: 'RULES📃' }, type: 1 },{ buttonId: `command`, buttonText: { displayText: 'MENU📒' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: iye, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
                    buffer = fs.readFileSync(`./stik/ara.mp3`)
ronove.sendMessage(from, buffer, audio, { mimetype: 'audio/mp4', quoted: fg3, ptt: true })
}
